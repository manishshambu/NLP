...
word_counts = dict()
pos_counts = dict()
InputFileName = "Input/gene-trainF17.txt"
#testFileName = "assgn2-test-set.txt"
dir_path = ""
trainingFile = "Input/gene-trainF17.txt"
testExpectedFile = "test_expected.txt"
testFile = "F17-assgn4-test.txt"
prefix_pattern = "(^[0-9])"
...
def buildBaseLine(fileContent):
    ...
    for line in fileContent:
            ...
            if column:
                ...
                #extract total occurences of a word and POS in the given data
...
def generateEmmisionCounts(observationSpace, stateSpace):
    ...
    for each in emmisionList:
        ...
        try:
            ...
            continue
    #print(emmisionBigramTransitionCounts)
...
def buildTestObservationInOrder(content):
    ...
    for line in content:
        if not line.strip():
            testObservation.append('@!')
            testObservationUnmodified.append('@!')
        column = line.split()
        if column:
