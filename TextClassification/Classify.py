...
if __name__ == "__main__":
    ...
    testSentences = open("HW3-testset.txt", 'r').readlines()
    ...
    testSentences = testSentences #sentenceArrayPositiveTest + sentenceArrayNegativeTest
    #shuffle(testSentences)

    #writeFile(sentenceArrayPositiveDev, "PosDevData.txt", "")
    writeFile(trainingInputContentPositive, "PosDevData.txt", "")

    #writeFile(sentenceArrayNegativeDev, "NegDevData.txt", "")
    writeFile(trainingInputContentNegative, "NegDevData.txt", "")
    ...
    logprior, loglikelihood, vocabulary = trainNaiveBayes(trainingInputContentPositive, trainingInputContentNegative)
